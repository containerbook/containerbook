...
---------------------------------------------
Building and deplying software in a container
---------------------------------------------
...
runtime library dependencies will not.

On my system, these are the runtime dependencies for `/bin/bash`:
...
So, in order to run `/bin/bash` within a container, we would also need ot copy
